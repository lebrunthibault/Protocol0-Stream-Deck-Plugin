...
function connected(jsn) {
    ...
    $SD.on('com.thibault.p0.action.willAppear', (jsonObj) => action.onWillAppear(jsonObj));
    $SD.on('com.thibault.p0.action.keyUp', (jsonObj) => action.onKeyUp(jsonObj));
    $SD.on('com.thibault.p0.action.sendToPlugin', (jsonObj) => action.onSendToPlugin(jsonObj));
    $SD.on('com.thibault.p0.action.didReceiveSettings', (jsonObj) => action.onDidReceiveSettings(jsonObj));
    $SD.on('com.thibault.p0.action.propertyInspectorDidAppear', (jsonObj) => {
        console.log('%c%s', 'color: white; background: black; font-size: 13px;', '[app.js]propertyInspectorDidAppear:');
    });
    $SD.on('com.thibault.p0.action.propertyInspectorDidDisappear', (jsonObj) => {
